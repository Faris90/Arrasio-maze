                ...
                let loop = (() => {
                    ...
                    return () => {
                        ...
                        case -1: { // removal
                            ...
                            // Rectangular maze walls.
                            // ============================================================
                            let index = minimap.findIndex(e => challenge(e, [x, y, color, size, sizeVert, rotation]));
                            // ============================================================
        ...
        { // Draw minimap and FPS monitors
            ...
            minimap.forEach(o => {
                ...
                // ============================================================
                    ...
                    const wallWidth = (o[3] * 2 / global.gameWidth) * minimapWidth;
                    const wallHeight = (o[4] * 2 / global.gameHeight) * minimapHeight;

                    let wallX = (minimapX + (o[0] / global.gameWidth) * minimapWidth) - (wallWidth / 2);
                    let wallY = (minimapY + (o[1] / global.gameHeight) * minimapHeight) - (wallHeight / 2);
